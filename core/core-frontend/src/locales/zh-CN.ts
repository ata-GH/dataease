...
export default {
  ...
  data_set: {
    ...
    to_delete_them: '该数据集存在如下血缘关系，删除会造成相关仪表盘的图表失效，确定删除？',
  ...
  data_source: {
    ...
    also_want_to: '您可能还想',
    or_large_screen: '为下一步的仪表盘或大屏做准备',
    go_to_create: '去创建',
    ...
    to_replace_it: '替换可能会影响自定义数据集、关联数据集、仪表盘等，是否替换？',
    document: '文件',
    reupload: '重新上传',
  ...
  components: {
    dashboard_style: '仪表盘风格',
    overall_configuration: '整体配置',
    dashboard_background: '仪表盘背景',
    chart_color: '图表配色',
    ...
    add_components_first: '当前仪表盘为空，请先添加组件',
    rich_text: '富文本',
    media: '媒体',
    dashboard_configuration: '仪表盘配置',
  ...
  chart: {
    align: '对齐方式',
    reset: '重置',
    chart_refresh_tips: '图表刷新设置优先于仪表盘刷新设置',
    '1-trend': '趋势',
    '2-state': '状态',
    '3-rank': '排名',
    '4-location': '位置',
    ...
    compare_calc_tip:
      '当对比日期需要过滤时，请使用过滤组件实现过滤；使用图表过滤器，仪表盘下钻和联动等功能，会导致结果不一致',
    and: '与',
    or: '或',
    logic_exp: '逻辑条件',
    enum_exp: '字段枚举值',
  ...
  dataset: {
    ...
    tips: '提示',
    confirm_delete: '确认删除',
    confirm_delete_msg: '数据集删除，会影响与其相关的自定义数据集、关联数据集、仪表盘，确认删除？',
    delete_success: '删除成功',
    confirm: '确认',
    cancel: '取消',
    search: '搜索',
    ...
    task: {
      ...
      excel_replace_msg: '可能会影响自定义数据集、关联数据集、仪表盘等，确认替换？',
  ...
  deDataset: {
    ...
    data_reference: '数据参考',
    want_to_replace: '替换可能会影响自定义数据集、关联数据集、仪表盘等，是否替换？',
  ...
  commons: {
    ...
    thumbnail: '缩略图',
    confirm_delete: '确认删除',
    delete_this_dashboard: '确认删除该仪表盘吗?',
  ...
  v_query: {
    ...
    here_or_click: '将左侧的字段拖拽到这里 或 点击',
  ...
  visualization: {
    ...
    target_dashboard_dataV: '目标仪表盘/数据大屏',
    dashboard_dataV: '仪表盘/数据大屏',
    ...
    select_target_dashboard_tips: '请选择目标仪表盘',
    select_target_screen_tips: '请选择目标数据大屏',
    cur_dashboard: '当前仪表盘',
    cur_screen: '当前数据大屏',
    target_dashboard: '目标仪表盘',
    ...
    export_tips: '当前仪表盘中{0}属于模版图表，无法导出，请先设置数据集！',
    preview_select_tips: '请在左侧选择仪表盘',
    have_none_resource: '暂无仪表盘',
    attribute: '属性',
    dashboard_configuration: '仪表盘配置',
    ...
    source_field: '源字段',
    source_filter: '源条件',
    link_target_tips1: '目标仪表盘无外部参数，因此无法携带条件查询，如有需要，',
    ...
    unpublished_tips: '取消发布后，该仪表盘不能被查看。确定要取消发布？',
    ...
    watermark: '水印',
    panel_get_data_error: '获取仪表盘信息失败，仪表盘可能已经被删除，请检查仪表盘状态',
    panel_no_save_tips: '存在未保存的仪表盘',
    panel_cache_use_tips: '检查到上次有仪表盘未能正常保存，是否使用上次未保存的仪表盘？',
    template_name_tips: '仪表盘名称必填',
    panel_background_item: '自定义仪表盘背景',
    ...
    link_expire: '链接已过期！',
    link_share: '链接分享',
    link_share_desc: '开启链接后，任何人可通过此链接访问仪表盘。',
    share: '分享',
    remove_share_confirm: '确认取消当前仪表盘所有分享？',
    share_in: '分享给我',
    share_out: '我的分享',
    who_share: '分享人',
    when_share: '分享时间',
    ...
    redo: '重做',
    undo: '撤销',
    panelNull: '这是个空的仪表盘，可以通过编辑来丰富内容',
    paste: '粘贴',
    cut: '剪切',
    lock: '锁定',
    unlock: '解锁',
    ...
    other_module: '其他',
    content: '内容',
    default_panel_name: '默认仪表盘名称',
    source_panel_name: '原仪表盘名称',
    content_style: '内容样式',
    canvas_self_adaption: '自适应画布区域',
    panel_save_tips: '仪表盘已变动，是否保存？',
    panel_save_warn_tips: '如果未保存，你对仪表盘做的变更将会丢失！',
    do_not_save: '不保存',
    save: '保存',
    drill: '下钻',
    linkage: '联动',
    ...
    aided_grid_close: '关闭',
    export_pdf_page: '分页线',
    export_pdf_page_remark: '仅对API导出仪表盘PDF分页有效',
    ...
    public_link_tips: '当前是公共链接模式，目标仪表盘未设置公共链接，无法跳转',
    input_title: '请输入标题',
    show_title: '标题',
    ...
    pdf_template_with_params: '默认模板(加仪表盘描述)',
  ...
  setting_basic: {
    default_open_tips: '涉及仪表盘、数据大屏等资源的新建与编辑界面',
    ...
    share_disable_tips: '开启后仪表盘以及大屏分享无效'
  },
  resource_sort: {
    time_asc: '按创建时间升序',
    time_desc: '按创建时间降序',
  ...
  watermark: {
    ...
    enable_panel_custom: '允许仪表盘或数据大屏单独打开或者关闭水印',
    content: '水印内容',
  ...
  free: {
    ...
    quick_sync_tips: '所有仪表盘、数据大屏、数据集、数据源，将全部迁移到【迁移资源】文件夹。',
    batch_sync_tips:
      '1. 与选中资源相关的仪表盘、数据大屏、数据集、数据源，也将一并迁移到对应资源的【迁移资源】文件夹；',
