...
import { DEFAULT_THRESHOLD } from '@/views/chart/componentsnew/util/chart'
import TableThresholdEdit from '@/views/chart/componentsnew/editor-senior/components/dialog/TableThresholdEdit.vue'
import TextLabelThresholdEdit from '@/views/chart/componentsnew/editor-senior/components/dialog/TextLabelThresholdEdit.vue'
import TextThresholdEdit from '@/views/chart/componentsnew/editor-senior/components/dialog/TextThresholdEdit.vue'
import LineThresholdEdit from '@/views/chart/componentsnew/editor-senior/components/dialog/LineThresholdEdit.vue'
import { fieldType } from '@/utils/attr'
import { defaultsDeep } from 'lodash-es'
import { iconFieldMap } from '@/components/icon-group/field-list'
import PictureGroupThresholdEdit from '@/views/chart/componentsnew/editor-senior/components/dialog/PictureGroupThresholdEdit.vue'
