...
import MiscSelector from '@/views/chart/componentsnew/editor-style/components/MiscSelector.vue'
import LabelSelector from '@/views/chart/componentsnew/editor-style/components/LabelSelector.vue'
import TooltipSelector from '@/views/chart/componentsnew/editor-style/components/TooltipSelector.vue'
import XAxisSelector from '@/views/chart/componentsnew/editor-style/components/XAxisSelector.vue'
import YAxisSelector from '@/views/chart/componentsnew/editor-style/components/YAxisSelector.vue'
import DualYAxisSelector from '@/views/chart/componentsnew/editor-style/components/DualYAxisSelector.vue'
import TitleSelector from '@/views/chart/componentsnew/editor-style/components/TitleSelector.vue'
import LegendSelector from '@/views/chart/componentsnew/editor-style/components/LegendSelector.vue'
import SummarySelector from '@/views/chart/componentsnew/editor-style/components/SummarySelector.vue'
import { dvMainStoreWithOut } from '@/store/modules/data-visualization/dvMain'
import { storeToRefs } from 'pinia'
import CollapseSwitchItem from '@/components/collapse-switch-item/src/CollapseSwitchItem.vue'
import { ElCollapse, ElCollapseItem } from 'element-plus-secondary'
import BasicStyleSelector from '@/views/chart/componentsnew/editor-style/components/BasicStyleSelector.vue'
import SymbolicStyleSelector from '@/views/chart/componentsnew/editor-style/components/SymbolicStyleSelector.vue'
import DualBasicStyleSelector from '@/views/chart/componentsnew/editor-style/components/DualBasicStyleSelector.vue'
import ComponentPosition from '@/components/visualization/common/ComponentPosition.vue'
import BackgroundOverallCommon from '@/components/visualization/component-background/BackgroundOverallCommon.vue'
import TableHeaderSelector from '@/views/chart/componentsnew/editor-style/components/table/TableHeaderSelector.vue'
import TableCellSelector from '@/views/chart/componentsnew/editor-style/components/table/TableCellSelector.vue'
import TableTotalSelector from '@/views/chart/componentsnew/editor-style/components/table/TableTotalSelector.vue'
import MiscStyleSelector from '@/views/chart/componentsnew/editor-style/components/MiscStyleSelector.vue'
import IndicatorValueSelector from '@/views/chart/componentsnew/editor-style/components/IndicatorValueSelector.vue'
import IndicatorNameSelector from '@/views/chart/componentsnew/editor-style/components/IndicatorNameSelector.vue'
import QuadrantSelector from '@/views/chart/componentsnew/editor-style/components/QuadrantSelector.vue'
import FlowMapLineSelector from '@/views/chart/componentsnew/editor-style/components/FlowMapLineSelector.vue'
import FlowMapPointSelector from '@/views/chart/componentsnew/editor-style/components/FlowMapPointSelector.vue'
import CommonBorderSetting from '@/custom-component/common/CommonBorderSetting.vue'
import { snapshotStoreWithOut } from '@/store/modules/data-visualization/snapshot'
import BulletTargetSelector from '@/views/chart/componentsnew/editor-style/components/bullet/BulletTargetSelector.vue'
import BulletMeasureSelector from '@/views/chart/componentsnew/editor-style/components/bullet/BulletMeasureSelector.vue'
import BulletRangeSelector from '@/views/chart/componentsnew/editor-style/components/bullet/BulletRangeSelector.vue'
